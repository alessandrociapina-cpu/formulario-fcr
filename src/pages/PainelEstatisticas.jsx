...
export default function PainelEstatisticas({ onBack }) {
  ...
  async function handleFiles(fileList) {
    ...
    if (parsed.length === 0) {
      setError('Nenhum arquivo JSON válido (formato FCR Vistoria) encontrado.')
      return
    }
    setReports((prev) => {
    ...
    <div className="min-h-screen bg-slate-100 max-w-lg mx-auto">
      <div className="bg-blue-900 text-white px-4 py-3 flex items-center gap-3 sticky top-0 z-40 shadow-md">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-bold text-sm">Painel de Estatísticas</p>
      ...
      <div className="p-4 space-y-4 pb-8">
        ...
        {!stats && (
          <div className="bg-white rounded-2xl p-10 text-center">
            ...
            <p className="text-xs text-slate-300 mt-1">Exporte vistorias do formulário FCR e importe aqui</p>
          </div>
        )}
          ...
          <>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                ].map(({ label, sub, value, bg, text, light }) => (
